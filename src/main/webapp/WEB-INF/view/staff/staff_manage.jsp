    ...
    <div class="block-right">
        <div class="content">
            <div class="box grid-search">
                <span>查询宿舍管理员</span>
                <div class="search">
                    <input type="text" name="key" id="key" placeholder="请输入宿舍管理员姓名">
...
<script type="text/javascript">
    ...
    function build_table_Information(pageInfo){
        ...
        $.each(list,function(index,staff){
            ...
            changeStatus.attr("change-id", staff.staffId);
    ...
    $(document).on("click",".change_btn",function(){
        ...
        if(confirm("确认更改该账户状态吗？")){
            $.ajax({
                url:"<%=request.getContextPath() %>/staff/change/"+Id,
                type:"get",
                success:function(){
                    to_page(pageNum, pageSize)
                }
    ...
    $("#submitButton").click(function() {
        var key = $("#key").val();
        window.location.href="<%=request.getContextPath() %>/guide/toStaffKeyList?key="+key;
    });
</script>
</body>
</html>